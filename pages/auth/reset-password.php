...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $subject = "Password Reset Successful - E-Vinty";
            $message = "
            <html>
            <head>
                <style>
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <p>Your password has been successfully reset for your E-Vinty account.</p>
                    ...
                    <div class='footer'>
                        <p>This email was sent from E-Vinty - Again&Co</p>
                    </div>
                </div>
            </body>
            </html>";
...
$page_title = "Reset Password - E-Vinty";
?>
