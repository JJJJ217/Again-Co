...
/**
 * Edit Product
 * Staff/Admin can edit product details and inventory
 */
...
// Get product data
try {
    $product = $db->fetch("SELECT * FROM products WHERE product_id = ?", [$product_id]);
    if (!$product) {
    ...
    try {
        ...
        $db->query(
            "UPDATE products SET 
             ...
             WHERE product_id = ?",
            [$product_name, $description, $price, $stock, $category, $brand, $condition_type, $image_url, $release_date, $is_active, $product_id]
        );
...
$page_title = "Edit Product - Again&Co";
?>
...
<body>
        ...
        <main class="admin-content">
            ...
            <div class="product-preview">
                ...
                <div class="product-info">
                    ...
                    <p style="color: #7f8c8d; margin: 0;"><?= htmlspecialchars($product['description']) ?></p>
                    ...
                    <div class="product-meta">
                        ...
                        <div class="meta-item">
                            ...
                            <span class="meta-value"><?= htmlspecialchars($product['category'] ?: 'Uncategorized') ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-container">
                <form method="POST" class="form-grid">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="condition_type" name="condition_type" class="form-control">
                                ...
                                <option value="like_new" <?= $product['condition_type'] === 'like_new' ? 'selected' : '' ?>>Like New</option>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="button" onclick="confirmDelete()" class="btn btn-danger">🗑️ Delete Product</button>
                    </div>
                </form>
            </div>
        </main>
    ...
    <script>
        function confirmDelete() {
            if (confirm('Are you sure you want to delete this product? This action cannot be undone and will also remove it from any existing orders.')) {
        ...
        document.getElementById('image_url').addEventListener('input', function() {
            ...
            if (imageUrl) {
                preview.innerHTML = `<img src="${imageUrl}" alt="Preview" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;" onerror="this.style.display='none'">`;
            } else {
                preview.innerHTML = '<div style="display: flex; align-items: center; justify-content: center; color: #7f8c8d; width: 100%; height: 100%;">📦</div>';
            }
        });
    </script>
